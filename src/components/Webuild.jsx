      ...
      <div className="absolute bottom-0 w-full flex justify-center">
        <div className="max-w-[1050px] rounded-[8px] w-full bg-[#16222F] h-[200px] md:h-[198px] flex flex-col items-center justify-center px-4 mx-auto">
          ...
          <div className="flex justify-center space-x-4 flex-wrap">
            <Image src="/cac.svg" width={300} height={50} alt="RSB Logo" className="w-[250px] md:w-[400px]" />
            <Image src="/rsb.svg" width={200} height={50} alt="CAC Logo" className="w-[180px] md:w-[300px]" />
          </div>
        </div>
      </div>
    </div>
