      ...
      <div className="absolute bottom-0 w-full flex justify-center">
        <div className="max-w-[1250px] rounded-[8px] w-full bg-[#16222F] h-[500px] md:h-[450px] lg:h-[450px] flex flex-col items-center justify-evenly px-4 mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-around  flex-wrap h-[80%] sm:h-[90%] md:h-[90%] w-[100%] md:w-[90%] items-center lg:content-center">
            ...
            <div className="w-[200px] sm:w-[300px] md:flex md:items-center md:w-[350px] md:h-[80px] lg:h-[140px] lg:w-[400px]"><Image src="/aviacaoSAF.png" width={70} height={30} alt="aviacao Saf Logo" className=" sm:w-[100px] sm:h-[12vh] md:w-[100px] md:h-[12vh] lg:w-[140px] lg:h-[12vh] xl:w-[145px] xl:h-auto 2xl:w-[142px] 2xl:h-[11vh]" /></div>
