      ...
      <div className="absolute bottom-0 w-full flex justify-center">
        <div className="max-w-[1250px] rounded-[8px] w-full bg-[#16222F] h-[500px] md:h-[750px] lg:h-[450px] flex flex-col items-center justify-evenly px-4 mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-around md:space-x-4 flex-wrap h-[80%] sm:h-[90%] md:h-[90%] w-[100%] items-center">
            <Image src="/ahkBrasil_svg.svg" width={150} height={40} alt="ahk Logo" className="sm:w-[250px] sm:h-[12vh] md:w-[400px] md:h-[15vh] 2xl:h-[12vh]" />
            ...
            <Image src="/arg2.svg" width={150} height={40} alt="ahk Logo" className="sm:w-[250px] sm:h-[12vh] md:w-[400px] md:h-[15vh] 2xl:h-[12vh]" />           
            ...
            <Image src="/aviacaoSAF.png" width={100} height={50} alt="aviacao Saf Logo" className=" sm:w-[130px] sm:h-[12vh] md:w-[140px] md:h-[14vh] 2xl:h-[10vh]" />
          </div>
        </div>
      </div>
    </div>
