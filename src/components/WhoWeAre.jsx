...
export default function WhoWeAre() {
    ...
    >
            <div className="min-h-[70vh] sm:min-h-[70vh] md:min-h-[90vh] xl:min-h-[70vh] 2xl:min-h-[75vh] ml-[24px] md:m-[0px] flex flex-col justify-center text-white   w-full">
                <div className="md:flex md:flex-col md:items-end h-[120px] 2xl:h-[190px]">
                    <div className="h-[120px] md:h-[100px] md:w-[90%] xl:w-[95%] flex items-end justify-end">
                        {/* Título animado letra por letra */}
                        <h3 className="text-[#0b0d0d] font-archivo text-[40px] md:text-[60px] xl:text-[80px] flex flex-wrap whitespace-nowrap overflow-hidden">
