...
export default function WhoWeAre() {
    ...
    return (
        <div
            id="WhoWeAre"
            ref={sectionRef}
            className="h-[100vh] md:h-[760px] flex items-center justify-end bg-[#101820]"
        >
            <div className="h-[100vh] m-[20px] md:m-[0px] md:h-[550px] flex flex-col justify-between text-white max-w-[1330px] 2xl:max-w-[1565px] w-full px-4 md:px-0">
