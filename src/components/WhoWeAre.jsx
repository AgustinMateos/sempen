...
export default function WhoWeAre() {
    ...
    >
            <div className="min-h-[70vh] sm:min-h-[170vh] md:min-h-[90vh] xl:min-h-[70vh] 2xl:min-h-[75vh] ml-[24px] md:m-[0px] flex flex-col justify-center text-white   w-full">
                <div className="md:flex md:flex-col md:items-end h-[120px] 2xl:w-[190px]">
