...
export default function AboutUs() {
    ...
    return (
        <div className=" h-auto overflow-hidden" id="AboutUs">
            ...
            <div
                className="w-full bg-cover bg-center flex flex-col items-center justify-around h-[545px] sm:h-[415px] md:h-[862px]  lg:h-[650px]  xl:h-[600px] 2xl:h-[590px] px-4 md:px-0"
                style={{
                    backgroundImage: `
