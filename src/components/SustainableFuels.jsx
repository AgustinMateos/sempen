...
export default function SustainableFuels() {
  ...
  return (
    ...
    id="SustainableFuels"
    ref={sectionRef}
    className="min-h-[60vh]  xl:min-h-[100vh] flex items-center md:justify-end bg-[#EDEDED] scroll-mt-[50px] sm:scroll-mt-20   xl:scroll-mt-[50px]"
  >
  ...
  <div className="flex flex-col justify-evenly text-[#101820] w-full">
    ...
    width={766}
    height={250}
    className="w-[95%] md:w-[88%] md:h-auto lg:h-[480px] xl:h-[321px] rounded-r-[10px] h-[220px] "
    loading="lazy"
    // srcSet="
